...
public class GroupStringByLength {
	...
	public static void main(String[] args) {
		...
		System.out.println(imperativeByLength(strings));

		System.out.println("Functional : ");
		System.out.println(functionalByLength(strings));

	}

	// Verbose
	public static Map<Integer, List<String>> imperativeByLength(List<String> strings) {
	...
	// Concise
	public static Map<Integer, List<String>> functionalByLength(List<String> strings) {
